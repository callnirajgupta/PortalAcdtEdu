...
Feature: personal details page fields validation
  ...
  Scenario: personal details page fields validation
    ...
    When user enter mandatory data in personal details page for following fields and validate error message
      ...
      # | Passport.jpg |       | TestFirstName | TestMiddleName     | testLastName   | asd       | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Title            |
      #| Passport.jpg | Miss   | TestFirstName | TestMiddleName     |          | TestOtherName       | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Surname          |
      | Passport.jpg | Miss  |               | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): First Name                 |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName |        | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Gender                     |
      ...
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 |                | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Country of Birth           |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          |             | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): City of Birth              |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          | city        |             | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Nationality                |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism |          | Ashanti | Yes         | comment | Please fill in the required field(s): Hometown                   |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown |         | Yes         | comment | Please fill in the required field(s): Region                     |
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 10/6/1999 | India          | city        | Afghanistan | Buddhism | hometown |         | Yes         | comment | Please fill in the required field(s): Special Need Status Reason |
