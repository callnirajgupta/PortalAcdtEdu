...
Feature: personal details page fields validation
  ...
  Scenario: personal details page fields validation
    ...
    When user enter mandatory data in personal details page for following fields and validate error message
      ...
      | Passport.jpg | Miss  |               | TestMiddleName | TestLastName | TestOtherName | M      | 12/6/1999 | India          | city        | Afghanistan | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): First Name                 |
      ...
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 13/6/1999 | India          | city        |             | Buddhism | hometown | Ashanti | Yes         | comment | Please fill in the required field(s): Nationality                |
      ...
      | Passport.jpg | Miss  | TestFirstName | TestMiddleName | TestLastName | TestOtherName | M      | 11/6/1999 | India          | city        | Afghanistan | Buddhism | hometown |         | Yes         | comment | Please fill in the required field(s): Special Need Status Reason |
