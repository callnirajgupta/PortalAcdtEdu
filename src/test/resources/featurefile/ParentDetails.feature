...
Feature: Particular of parner page fields validation
  ...
  Scenario: parent details page mandatory field validation
    ...
    When user enter mandatory fields data in parent details page and validate error message
      ...
      # Defect| Miss  | surename | firstname | middle     | Parent       | ABC company |            | address1 | address2 | Albania | cityTown | state | 235434587687 | 3535348788 | Automation@gmail.com |       4646 | Please fill in the required field(s): Occupation                           |
      ...
      #defect | Miss  | surename | firstname | middle     | Parent       | ABC company | service    | address1 | address2 |         | cityTown | state | 235434587687 | 3535348788 | Automation@gmail.com |       4646 | Please fill in the required field(s): Country                 |
