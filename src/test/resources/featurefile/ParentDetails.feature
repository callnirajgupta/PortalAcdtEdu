...
Feature: Particular of parner page fields validation
  ...
  Scenario: parent details page mandatory field validation
    ...
    When user enter mandatory fields data in parent details page and validate error message
      ...
      # Defect| Miss  | Testsurename | Testfirstname | Testmiddle     | Parent       | Test company |            | Testaddress1 | address2 | Albania | cityTown | state | 235434587687 | 3535348788 | Automation@gmail.com |       4646 | Please fill in the required field(s): Occupation                           |
      ...
      #defect | Miss  | Testsurename | Testfirstname | Testmiddle     | Parent       | Test company | Testservice    | Testaddress1 | address2 |         | cityTown | state | 235434587687 | 3535348788 | Automation@gmail.com |       4646 | Please fill in the required field(s): Country                 |
  ...
  #Defect|   Miss  | Testsurename | Testfirstname | middle     | Parent       | Test company | service    | Testaddress1 | address2 | Albania | cityTown | state | 235434587687 |            | Automation@gmail.com |       4646 | Please fill in the required field(s): Telephone, Invalid Telephone Number  |
  #defect| Miss  | Testsurename | Testfirstname | middle     | Parent       | Test company | service    | Testaddress1 | address2 | Albania | cityTown | state | 235434587687 |1            | Automation@gmail.com |       4646 | Please fill in the required field(s): Invalid Telephone Number  |
