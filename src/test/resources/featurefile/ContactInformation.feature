...
Feature: Contact Infomation page fields validation
  ...
  Scenario: contact information page validation of postal address same as  permanent address
    ...
    When user enter data in contact information page for postal address
      | TestAddress1 | TestAddress2 | TestCity | TestState | Country     | PostalCode | Phone     |
      | TestAddress1 | TesAddress2  | TestCity | TesState  | Afghanistan |    1313124 | 123456789 |
  ...
  Scenario: contact information page validation of mandatory fields for permanent address
    ...
    When user enter  mandatory fields data in contact information page for permanent address and validate error message
      | Address1 | Address2 | City | State | Country     | PostalCode | Phone         | Message                                                          |
      |          |          | Testcity |       | Afghanistan |    1313124 | +919241521992 | Please fill the required field(s): Permanent Address Address 1   |
      | TestAddress1 |          |      |       | Afghanistan |    1313124 | +913241521992 | Please fill the required field(s): Permanent Address City/Town   |
      | TestAddress1 |          | Testcity |       |             |    1313124 | +913241521992 | Please fill the required field(s): Permanent Address Country     |
      | TestAddress1 |          | Testcity |       | Afghanistan |            | +913241521992 | Please fill the required field(s): Permanent Address Postal Code |
