...
Feature: Contact Infomation page fields validation
  ...
  Scenario: contact information page validation of mandatory fields for postal address
    ...
    When user enter  mandatory fields data in contact information page for postal address and validate error message
      ...
      |          |          | city |       | Afghanistan |    1313124 | +919241521992 | Please fill the required field(s): Postal Address Address 1         |
      | Address1 |          |      |       | Afghanistan |    1313124 | +919241521992 | Please fill the required field(s): Postal Address City/Town         |
      | Address1 |          | city |       |             |    1313124 | +919241521992 | Please fill the required field(s): Postal Address Country           |
      | Address1 |          | city |       | Afghanistan |            | +919241521992 | Please fill the required field(s): Postal Address Postal Code       |
  ...
  Scenario: contact information page validation of mandatory fields for permanent address
    ...
    When user enter  mandatory fields data in contact information page for permanent address and validate error message
      | Address1 | Address2 | City | State | Country     | PostalCode | Phone     | Message                                                             |
      |          |          | city |       | Afghanistan |    1313124 | +919241521992  | Please fill the required field(s): Permanent Address Address 1         |
      | Address1 |          |      |       | Afghanistan |    1313124 | +913241521992  | Please fill the required field(s): Permanent Address City/Town         |
      | Address1 |          | city |       |             |    1313124 | +913241521992  | Please fill the required field(s): Permanent Address Country           |
      | Address1 |          | city |       | Afghanistan |            | +913241521992  | Please fill the required field(s): Permanent Address Postal Code       |
      #| Address1 |          | city |       | Afghanistan |    1313124 |           | Please fill the required field(s): Invalid Postal Address Telephone |
