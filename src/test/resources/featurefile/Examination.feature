...
Feature: Title of your feature
  ...
  Scenario: Enter mandatory Examination field and validate message
    ...
    When user enter mandatory fields data in examination page and validate error message
      ...
      |                 |           8 | 10/6/1999        |Passport.jpg    |Please enter the required field(s):Examination Type for undefined             |
      | WASSCE          |             | 10/6/1999         |Passport.jpg    |Please enter the required field(s):Index Number for WASSCE        |
      | WASSCE          |           8 |                 |Passport.jpg    | Please enter the required field(s):Date of Examination for WASSCE |
      | WASSCE          |           8 | 10/6/1999      |                | Please enter the required field(s):Result slip for WASSCE. |
  ...
  @Examination4
  Scenario: Educational Background page filled data persist when user click on previous button in Examination page
    Given user navigates to home page
    When user click on start application button in home page
    And user enter mandatory data field in signup page
      | FirstName     | LastName     | MiddleName     | ProgrammeType | Gender | CountryOfResidence | MobileNumber  | EmailAddress | Password | ConfirmPassword | Captcha |
    ...
    Then verify that user navigation to Educational Background page
    And validate that Educational Background page filled data persist 
